        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    ...
                    <div class="text-sm text-gray-500 mt-1">Albums Rated</div>
                </div>
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    ...
                    <div class="text-sm text-gray-500 mt-1">Artists Explored</div>
                </div>
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                    <div class="text-3xl font-bold text-orange-600">{{ $stats['memberSince']->diffForHumans(null, true) }}</div>
                    <div class="text-sm text-gray-500 mt-1">Member Since</div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="p-6">
                        <div class="flex justify-between items-center mb-4">
                            ...
                            @if($recentRatings->count() > 0)
                                <a href="{{ route('account') }}" class="text-sm text-blue-600 hover:text-blue-800">View all</a>
                            @endif
                        </div>
                                            ...
                                            <div class="min-w-0">
                                                ...
                                                @if($rating->album?->artist)
                                                    <a href="{{ route('artist.show', $rating->album->artist) }}"
                                                       class="text-xs text-gray-500 hover:text-gray-700 truncate block">
                        ...
                        @else
                            <div class="text-center py-8">
                                ...
                                <p class="mt-2 text-sm text-gray-500">No ratings yet</p>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <h3 class="text-lg font-semibold text-gray-900 mb-4">Your Top Rated Albums</h3>
                        ...
                        @else
                            <div class="text-center py-8">
                                ...
                                <p class="mt-2 text-sm text-gray-500">Start rating albums to see your favorites here</p>
                            </div>
                        @endif
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <a href="{{ route('home') }}"
                           class="flex flex-col items-center p-4 rounded-lg border border-gray-200 hover:border-blue-500 hover:bg-blue-50 transition-colors">
                            ...
                            <span class="text-sm font-medium text-gray-700">Search Music</span>
                        </a>
