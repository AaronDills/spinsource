    ...
    <div class="max-w-4xl mx-auto px-4 py-8">
        <div class="card">
            <div class="p-6 sm:p-8">
                ...
                @php
                    $streamingLinks = $deduplicatedLinks->whereIn('type', ['spotify', 'apple_music', 'youtube', 'deezer', 'soundcloud', 'bandcamp']);
                    $socialLinks = $deduplicatedLinks->whereIn('type', ['twitter', 'instagram', 'facebook', 'reddit']);
                ...
                @if($artist->wikipedia_url || $artist->musicbrainz_id || $artist->wikidata_id || $artist->discogs_artist_id)
                    <div class="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
                            ...
                            @if($artist->discogs_artist_id)
                                <a href="https://www.discogs.com/artist/{{ $artist->discogs_artist_id }}"
                                   ...
                                   class="inline-flex items-center px-4 py-2 bg-gray-800 hover:bg-gray-900 text-white rounded-lg transition-colors">
                                    <svg class="w-5 h-5 mr-2" viewBox="0 0 24 24" fill="currentColor">
                                        <path d="M12 0C5.372 0 0 5.372 0 12s5.372 12 12 12 12-5.372 12-12S18.628 0 12 0zm6.715 17.424c-1.57 1.878-3.878 2.965-6.358 2.965h-.714c-2.48 0-4.788-1.087-6.358-2.965-.263-.315-.22-.785.096-1.047.315-.263.784-.22 1.047.095 1.285 1.536 3.177 2.422 5.215 2.422h.714c2.038 0 3.93-.886 5.215-2.422.263-.315.732-.358 1.047-.095.316.262.359.732.096 1.047zm.855-4.924c0 .428-.347.775-.775.775h-1.238c-.376 2.098-2.205 3.696-4.4 3.696h-.714c-2.195 0-4.024-1.598-4.4-3.696H6.805c-.428 0-.775-.347-.775-.775s.347-.775.775-.775h1.238c.376-2.098 2.205-3.696 4.4-3.696h.714c2.195 0 4.024 1.598 4.4 3.696h1.238c.428 0 .775.347.775.775zm-7.57 2.2c1.343 0 2.448-1.01 2.606-2.31H9.394c.158 1.3 1.263 2.31 2.606 2.31zm0-6.01c-1.343 0-2.448 1.01-2.606 2.31h5.212c-.158-1.3-1.263-2.31-2.606-2.31z"/>
                                    </svg>
                                    Discogs
                                </a>
                            @endif
                            ...
                            @if($artist->musicbrainz_id)
                                <a href="https://musicbrainz.org/artist/{{ $artist->musicbrainz_id }}"
                                   ...
                                   class="inline-flex items-center px-4 py-2 bg-amber-600 hover:bg-amber-700 text-white rounded-lg transition-colors">
                                    <svg class="w-5 h-5 mr-2" viewBox="0 0 24 24" fill="currentColor">
                                        <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm0 2.824a9.176 9.176 0 110 18.352 9.176 9.176 0 010-18.352zm0 1.412a7.765 7.765 0 100 15.529 7.765 7.765 0 000-15.529zm0 1.412a6.353 6.353 0 110 12.705 6.353 6.353 0 010-12.705zm0 1.412a4.94 4.94 0 100 9.882 4.94 4.94 0 000-9.882zm0 1.411a3.53 3.53 0 110 7.058 3.53 3.53 0 010-7.058zm0 1.412a2.118 2.118 0 100 4.235 2.118 2.118 0 000-4.235z"/>
                                    </svg>
                                    MusicBrainz
                                </a>
                            @endif
                            ...
                            @if($artist->wikidata_id)
                                <a href="https://www.wikidata.org/wiki/{{ $artist->wikidata_id }}"
                                   ...
                                   class="inline-flex items-center px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg transition-colors">
                                    <svg class="w-5 h-5 mr-2" viewBox="0 0 24 24" fill="currentColor">
                                        <path d="M0 4.583v14.834h.865V4.583zm1.788 0v14.834h1.73V4.583zm2.653 0v14.834h.865V4.583zm11.063 0v14.834h.865V4.583zm1.788 0v14.834h1.73V4.583zm2.653 0v14.834h.865V4.583zM8.41 6.604l1.36 2.844H8.227l-.79-1.755-.756 1.755H5.148l1.341-2.765-1.262-2.653h1.515l.69 1.609.723-1.61h1.512zm3.275 0l1.36 2.844h-1.543l-.79-1.755-.756 1.755H8.423l1.341-2.765-1.262-2.653h1.515l.69 1.609.723-1.61h1.512z"/>
                                    </svg>
                                    Wikidata
                                </a>
                            @endif
