...
namespace App\Models {
     ...
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\ArtistLink> $links
    ...
    /**
     * App\Models\ArtistLink
     *
     * @property-read \App\Models\Artist $artist
     * @method static \Illuminate\Database\Eloquent\Builder<ArtistLink>|ArtistLink newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<ArtistLink>|ArtistLink newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<ArtistLink>|ArtistLink query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class ArtistLink extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     *
     * @property-read \App\Models\Country $country
     * @property-read \App\Models\Genre $parent
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\Genre> $children
    ...
    /**
     * App\Models\UserAlbumRating
     *
     * @property-read \App\Models\User $user
     * @property-read \App\Models\Album $album
     * @method static \Illuminate\Database\Eloquent\Builder<UserAlbumRating>|UserAlbumRating newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<UserAlbumRating>|UserAlbumRating newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<UserAlbumRating>|UserAlbumRating query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class UserAlbumRating extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
